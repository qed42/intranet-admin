...
module.exports = function(Admin, app, auth, database) {
  ...
  app.get('/admin/themes/customThemes', auth.requiresAdmin, function(req, res) {
    themes.myCustomThemeLoad(req, res);
  });

  app.get('/admin/themes/custom_update', auth.requiresAdmin, function(req, res) {
    themes.customCssUpdate(req, res);
  });

  app.get('/admin/themes/set_theme', auth.requiresAdmin, function(req, res) {
    themes.set_current_theme(req, res);
  });
